...
const problems: ProblemItem[] = [
  {
    ...
    solution:
      'Збільшення грудей за допомогою імплантів або ліпофілінгу може допомогти досягти бажаного розміру та форми. Сучасні методи дозволяють створити природний вигляд та відчуття. Ми підбираємо оптимальний розмір та форму імплантів, враховуючи індивідуальні особливості тіла та побажання пацієнтки.',
    image: '/images/breast-problems/small-breasts.jpg',
  },
  {
    title: 'Асиметричність форми',
    content:
      'Асиметрія грудей - це поширена проблема, яка може бути помітною або незначною. Вона може виникнути через генетичні фактори, гормональні зміни або в результаті попередніх операцій. Асиметрія може викликати дискомфорт при носінні бюстгальтерів та одягу.',
    solution:
    ...
    image: '/images/breast-problems/asymmetry.jpg',
  },
  {
    ...
    image: '/images/breast-problems/tubular-breasts.jpg',
  },
  {
    ...
    image: '/images/breast-problems/empty-sac.jpg',
  },
  {
    title:
    ...
    image: '/images/breast-problems/sagging-breasts.jpg',
  },
];
