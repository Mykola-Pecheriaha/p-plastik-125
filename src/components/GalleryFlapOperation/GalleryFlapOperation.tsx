...
import styles from './GalleryFlapOperation.module.css';
...
interface GalleryFlapOperationProps {
  images: ImageType[];
  galleryId: string;
  initialZoom?: number;
}

const GalleryFlapOperation: FC<GalleryFlapOperationProps> = ({
  images,
  galleryId,
  initialZoom = 1,
}) => {
...
export default GalleryFlapOperation;
