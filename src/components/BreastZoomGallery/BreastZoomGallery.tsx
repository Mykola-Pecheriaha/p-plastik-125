...
import styles from './BreastZoomGallery.module.css';
...
interface BreastZoomGalleryProps {
  images: ImageType[];
  galleryId: string;
  initialZoom?: number;
}

const BreastZoomGallery: FC<BreastZoomGalleryProps> = ({
  images,
  galleryId,
  initialZoom = 1,
}) => {
...
export default BreastZoomGallery;
