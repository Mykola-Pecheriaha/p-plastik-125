...
const problems = [
  ...
  },
  {
    ...
    content:
      'Різниця у розмірі молочних залоз більш ніж у ½ обсягу потребує хірургічної корекції. До прикладу асиметрія при синдромі Поланда.  Для усунення асиметрії підбираються різні імплантати або корекція поєднується з додатковою підтяжкою.',
  },
  {
    title: 'Вікові зміни',
    content:
      'Пластика дозволяє збільшити груди і повернути колишню пружність. При використанні імпланті в пацієнтів старшого віку досить уважно треба обстежити і молочну залозу а також прискіпливо оглянути шкірні покрови  (шкірний чехол) чи зможе він утримувати імпланти. Можливо слід розглянути і питання мастопексії ',
  },
];
...
const knowledgeItems = [
  ...
  },
  {
    ...
    fullContent: `Імплантація потребує ретельної підготовки. Пластична операція щодо збільшення грудей, техніка проведення та ціна визначаються після комплексного обстеження пацієнтки. Воно включає: УЗД, мамографію (при необхідності), огляд профільних фахівців та здає аналізи. 
  ...
  },
  {
    ...
    Питання встановлення імплантату – над м'язом або під ним – це рішення пластичного хірурга. Рекомендуємо прислухатися до його думки. Пластичний хірург Микола Печеряга віддає перевагу способу встановлення імплантату під м'яз. Цей спосіб розташування дозволяє уникнути контурування імплантату в області верхнього полюса грудей і знижує ризик виникнення капсулярної контрактури.`,
  },
];
