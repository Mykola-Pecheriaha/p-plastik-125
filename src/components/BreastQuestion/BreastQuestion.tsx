  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Шви не треба знімати! Використовуємо нитки, що саморозсмоктуються.
          Також працюємо зі спеціальним медичним клеєм для шкіри, який прискорює
          загоєння рубців. Ми отримуємо високі естетичні результати – через 1
          місяць рубець виглядає, як через 6-8 місяців.
        </p>
