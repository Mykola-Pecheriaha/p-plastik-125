...
const methods: Method[] = [
  {
    ...
    description:
      "Найбільш популярний спосіб, що дозволяє встановити імплантат будь-якого об'єму. Рубець розташовуватиметься у підгрудній складці. Також через цей доступ можна розташувати імпланти під залозою, під фасцією або під м'язом. Рубець в подальшому практично невидимим і скритий в субмамарні складці.",
  },
  {
    title: 'Розріз нижнього краю ареоли (періареолярний)',
    description:
      "Зручний метод корекції форми залози. Шов після операції розташовуватиметься на межі темної та світлої шкіри ареоли.Однак з цього доступу досить важко розмістити імплант під м'язом .",
  },
  {
    title: 'Розріз у пахвовій западині (аксиллярний)',
    description:
      'Метод часто називають "безшовним", тому що на молочній залозі не залишається видимих ​​слідів. Післяопераційний рубець захований від сторонніх очей у пахвовій западині. Такий доступ використовується досить рідко',
  },
];
